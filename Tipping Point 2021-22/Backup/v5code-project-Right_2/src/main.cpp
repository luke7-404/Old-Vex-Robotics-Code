...
void autonomous(void) {
  ...
  wait(1, sec);
  //2nd rotate
  lf.spinFor(forward, 215, deg, false);
  lm.spinFor(forward, 215, deg, false);
  lb.spinFor(forward, 215, deg, false);
  rf.spinFor(forward, 215, deg, false);
  rm.spinFor(forward, 215, deg, false);
  rb.spinFor(forward, 215, deg, true);
  //back
  lf.spinFor(reverse, 650, deg, false);
  lm.spinFor(reverse, 650, deg, false);
  lb.spinFor(reverse, 650, deg, false);
  rf.spinFor(forward, 650, deg, false);
  rm.spinFor(forward, 650, deg, false);
  rb.spinFor(forward, 650, deg, true);

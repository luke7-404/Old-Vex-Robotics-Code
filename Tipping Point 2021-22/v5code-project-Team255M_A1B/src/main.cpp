...
void autonomous(void) {
  Drivetrain.setDriveVelocity(250, vex::velocityUnits::pct);
  FrontClaw.set(false);
  Drivetrain.driveFor(forward, 62, inches);
  Backpack.spin(reverse, 150, pct);
  wait(0.75, sec);
  Drivetrain.driveFor(forward, 3, inches);
  FrontClaw.set(true);
  wait(1, sec);
  Drivetrain.driveFor(reverse, 33, inches);
  lift.spin(forward, 150, pct);
  Drivetrain.turnFor(left, 77.5, degrees);
  wait(1, sec);
  Drivetrain.driveFor(reverse, 17, inches);
  Backpack.spin(forward, 150, pct);
  wait(1, sec);
  Drivetrain.driveFor(forward, 13, inches);
  Backpack.spin(reverse, 150, pct);
  wait(1, sec);
  Drivetrain.driveFor(forward, 12, inches);
  lift.spin(reverse, 150, pct);
}

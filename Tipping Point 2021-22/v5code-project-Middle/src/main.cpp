...
void autonomous(void) {
 lf.setVelocity(350,vex::percentUnits::pct);
  ...
  lf.spinFor(forward, 2415, deg, false);
  lm.spinFor(forward, 2415, deg, false);
  lb.spinFor(forward, 2415, deg, false);
  rf.spinFor(reverse, 2415, deg, false);
  rm.spinFor(reverse, 2415, deg, false);
  rb.spinFor(reverse, 2415, deg, true);
  lift.spin(forward, 70, pct);
  wait(1.5, sec);
  lf.spinFor(reverse, 1500, deg, false);
  lm.spinFor(reverse, 1500, deg, false);
  lb.spinFor(reverse, 1500, deg, false);
  rf.spinFor(forward, 1500, deg, false);
  rm.spinFor(forward, 1500, deg, false);
  rb.spinFor(forward, 1500, deg, true);
  BackClaw.set(true);
  BackClaw.set(false);
  BackClaw.set(true);
}

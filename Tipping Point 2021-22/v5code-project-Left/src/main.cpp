...
void autonomous(void) {
  ...
  lf.spinFor(forward, 1730, deg, false);
  lm.spinFor(forward, 1730, deg, false);
  lb.spinFor(forward, 1730, deg, false);
  rf.spinFor(reverse, 1730, deg, false);
  rm.spinFor(reverse, 1730, deg, false);
  rb.spinFor(reverse, 1730, deg, true);
  FrontClaw.set(true);
  lf.spinFor(reverse, 1300, deg, false);
  lm.spinFor(reverse, 1300, deg, false);
  lb.spinFor(reverse, 1300, deg, false);
  rf.spinFor(forward, 1300, deg, false);
  rm.spinFor(forward, 1300, deg, false);
  rb.spinFor(forward, 1300, deg, true);
  }
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
